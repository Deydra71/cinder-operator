...
import (
	...
	"github.com/openstack-k8s-operators/cinder-operator/internal/cindervolume"
...
func (r *CinderVolumeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	...
	// index topologyField
	if err := mgr.GetFieldIndexer().IndexField(context.Background(), &cinderv1beta1.CinderVolume{}, topologyField, func(rawObj client.Object) []string {
